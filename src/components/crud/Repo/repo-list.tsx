				...
				<Dialog
					...
					<DialogContent dividers>
						<form onSubmit={handleSubmit(onSubmit)}>
							...
							<div className={styles.textCenter}>
								<Button variant='contained' disabled={submitting} type='submit' color='primary' style={{ margin: '10px' }}>
									Submit
								</Button>
								<Button onClick={handleCloseDialog} variant='contained' color='primary' style={{ margin: '10px' }}>
									Back
								</Button>
							</div>
						</form>
