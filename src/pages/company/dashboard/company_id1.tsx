...
export const getServerSideProps = async (context) => {
    ...
    let videoList = null;
    try {
        company_nano = context.params.company_id1;
...
const TemplateOne = ({ isError, company, categories, blogs }) => {
    console.log("test company result---->", company)
    ...
    return (
        <>
            <div className={styles.container}>
                ...
                <div>
                    Create a Tumblr-style blog using Jekyll! Tumble comes with post types, a simply beautiful design, and lots of customization
					options.
				</div>
