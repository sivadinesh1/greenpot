...
export const getServerSideProps = async (context) => {
  ...
  const data=await jsonToHtml(json);
  return {props: {data}};
};

 const ReactEditor = ({data}) => {
  console.log("Test Html code",data)
  const instanceRef = React.useRef(null);
      ...
      return(
        ...
        <div style={{padding:"1rem 3.5rem",fontSize:"20px",fontWeight: "bold",textAlign:"center"}}>Test Preview</div>
